        ...
        <div className="grid gap-10 lg:grid-cols-[1fr_360px]">
          <div className="min-w-0">
            ...
            {tour.whatToBring && tour.whatToBring.length > 0 && (
              <div className="mt-8">
                <h3 className="font-display text-base font-semibold text-foreground">What to bring</h3>
              ...
              <div className="mt-8">
                ...
                <div className="mt-3 flex flex-col gap-3">
                  {tour.addOns.map((addOn) => (
                    <div key={addOn.name} className="rounded-xl border border-border bg-card p-4">
